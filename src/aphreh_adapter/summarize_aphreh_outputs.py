...
This script reads the APHREH output folder and automatically detects:
    - the MAX_WMARM_* folder selected by the model;
    - all parameter combinations available under Parametric/.
        ...
        [
            {
                ...
                "WMARM": wmarm,
                "Interpretation_note": (
                    "Intermediate percentile-lag mini-sweep. "
                    "The selected parameter maximizes WMARM within the reduced grid only."
                ),
            }
        ]
    )
...
def main() -> None:
    ...
    parameter_sweep_path = SUMMARY_OUTPUT_DIR / "aphreh_pilot_parameter_sweep_summary.csv"
